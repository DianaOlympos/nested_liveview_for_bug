defmodule NestedLiveviewForBugWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(NestedLiveviewForBugWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(NestedLiveviewForBugWeb.Gettext, "errors", msg, opts)
    # end
